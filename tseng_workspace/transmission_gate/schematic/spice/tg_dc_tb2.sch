...
* DC analysis
dc vin_pmos_sw 0 1.8 0.01
dc vin_nmos_sw 0 1.8 0.01
*plot i(Vitg)
*plot ylog i(Vitg)
*plot ylog 1.8/i(Vitg)
let vsd_pmos_sw=v(vin_pmos_sw)-v(v2p)
let ron_pmos_sw=vsd_pmos_sw/i(vi_pmos_sw)
let vds_nmos_sw=v(vin_nmos_sw)-v(v2n)
let ron_nmos_sw=vds_nmos_sw/i(vi_nmos_sw)
plot ron_pmos_sw ron_nmos_sw
.endc"}
...
C {devices/lab_pin.sym} 410 40 2 1 {name=p15 sig_type=std_logic lab=vin_nmos_sw}
C {devices/ammeter.sym} 460 40 3 0 {name=vi_nmos_sw savecurrent=true}
C {devices/vsource.sym} 790 -190 0 0 {name=Vin_pmos_sw value=0 savecurrent=false}
C {devices/gnd.sym} 790 -140 0 0 {name=Vin_pmos_only2 lab=GND}
C {devices/lab_pin.sym} 790 -240 3 1 {name=p17 sig_type=std_logic lab=vin_pmos_sw}
C {devices/vsource.sym} 1030 -190 0 0 {name=Vin_nmos_sw value=0 savecurrent=false}
C {devices/gnd.sym} 1030 -140 0 0 {name=Vin_pmos_only3 lab=GND}
C {devices/lab_pin.sym} 1030 -240 3 1 {name=p18 sig_type=std_logic lab=vin_nmos_sw}
...
C {devices/lab_pin.sym} 410 -150 2 1 {name=p11 sig_type=std_logic lab=vin_pmos_sw}
...
C {devices/capa.sym} 210 -140 0 0 {name=CLn
m=1
value=Cload
footprint=1206
device="ceramic capacitor"}
C {devices/gnd.sym} 210 -90 0 0 {name=l1 lab=GND}
C {devices/lab_pin.sym} 210 -190 3 1 {name=p2 sig_type=std_logic lab=v2n}
C {devices/lab_pin.sym} 620 40 0 1 {name=p3 sig_type=std_logic lab=v2n}
