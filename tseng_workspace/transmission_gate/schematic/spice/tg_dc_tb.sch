...
C {devices/code_shown.sym} 20 50 0 0 {name=spice only_toplevel=false value=".option savecurrent
.control
save all
...
C {devices/vsource.sym} -230 -150 0 0 {name=V1 value=0 savecurrent=false}
C {devices/lab_pin.sym} -230 -200 3 1 {name=p1 sig_type=std_logic lab=v1}
C {devices/gnd.sym} -160 -100 0 0 {name=l2 lab=GND}
C {devices/vsource.sym} -160 -150 0 0 {name=Von value=1.8 savecurrent=false}
